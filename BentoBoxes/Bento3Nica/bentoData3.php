...
<div id='subtitle'>(BENTO box 3)</div>
<div id=\"middle1\">
...
<div id=\"middle2\"> The Bentobox1 Readings are: <br>
...
<tr bgColor = \"#F0F0F0\">
		...
		<th colspan=\"2\">Heating Temperature(C)</th>
		<th colspan=\"2\">SHeating Voltage (V)</th>
		<th colspan=\"2\">CO2 in ppm</th>
		<th colspan=\"2\">SO2 in ppm</th>
	</tr>";
	
	// Get all the data from the "example" table
	$result = mysql_query("SELECT * FROM  `BENTOBOX3` ORDER BY  `BENTOBOX3`.`RecordTime` ASC ") or die(mysql_error());  
